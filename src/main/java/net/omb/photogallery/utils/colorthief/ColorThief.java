package net.omb.photogallery.utils.colorthief;

import java.awt.image.BufferedImage;
import java.awt.image.DataBufferByte;
import java.util.Arrays;
import net.omb.photogallery.utils.colorthief.MMCQ.CMap;
...
public class ColorThief {
     ...
     */
    public static String getColorAsHash(BufferedImage sourceImage) {
        int[][] palette = getPalette(sourceImage, 5);
        if (palette == null) {
            return "#ffffff";
        }
        int[] dominantColor = palette[0];
        return createRGBHexString(dominantColor);
    }
